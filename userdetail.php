                    ...
                    <table class="table table-bordered" id="dataTable" width="60%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                             ...
                             $query_run = mysqli_query($mysqli, $q);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class ="btn-danger btn"><a href="deleteuser.php?id=<?php echo $row['id'];?>"
                                          class="text-white">DELETE</a></button>
                                        
                                    </td>
                                    <td>
                                       
                                            <button class ="btn-primary btn"><a href="updateuser.php?id=<?php echo $row['id'];?>"
